...
const IndexPage = () => (
  <Layout>
    ...
    <div class="row mb-4 px-3 pt-4 pb-2 bg-wash tw-border-b-4 tw-border-gray-600">
      ...
      <div class="col-12 col-xl-8">
        <p class="emphasis">
          ...
          provides public access to computational platforms and analysis tools
          that enable collecting, archiving, updating, and integrating a variety
          of genomics and related research data relevant to infectious diseases,
    ...
    <div class="row">
      <div class="col-md-12">
        <p>
          The current BRCs are the Bacterial and Viral Bioinformatics Resource
          Center (
          <a href="https://www.bv-brc.org" target="_blank">
            BV-BRC
          </a>
          ) for bacterial and viral pathogens, and the Eukaryotic Pathogen, Host
          & Vector Genomics Resource (
          <a href="https://veupathdb.org/veupathdb/app/" target="_blank">
            VEuPathDB
          </a>
          ) for eukaryotic pathogens and invertebrate vectors of infectious
          diseases. Access to tools and data from both resources is available
          ...
          <div class="org-circle">
            ...
            <div class="info info-left">
              ...
              >
                <ul>
                  <li>
                    <a href="https://hostdb.org/hostdb/app" target="_blank">
                      HostDB
                    </a>
                  </li>
                </ul>
          ...
          <div class="org-circle">
            ...
            <div class="info info-right">
              ...
              <div id="do_bacteria" style={{ display: "none" }}>
                <ul>
                  <li>
                    <a href="https://www.patricbrc.org/" target="_blank">
                      PATRIC
                    </a>
                  </li>
                </ul>
          ...
          <div class="org-circle">
            ...
            <div class="info info-left">
              ...
              <div id="do_fungi" style={{ display: "none" }}>
                <ul>
                  <li>
                    <a href="https://fungidb.org/fungidb/app" target="_blank">
                      FungiDB
                    </a>
                  </li>
                </ul>
    ...
    <div className="bg-wash tw-border-b-4 tw-border-gray-600 mt-4">
      <div class="row mt-1">
        <div class="col-md-12">
          ...
          >
            These projects have been funded in whole or in part with Federal
      ...
      <div class="row mb-3">
        <div class="col-md-6 mb-4 mb-md-0">
          <div class="bg-wash p-3 pb-0 h-100">
            ...
            <p>
              Contract No. 75N93019C00076, awarded to the University of Chicago
            </p>
            <div class="social-buttons">
              <ul class="list-group list-group-horizontal">
                <li class="list-group-item">
                  <a href="https://twitter.com/BVBRC_DB" target="_blank">
                    <i class="fab fa-twitter"></i>
                  </a>
                </li>
                <li class="list-group-item">
                  <a href="https://www.facebook.com/BVBRC19" target="_blank">
                    <i class="fab fa-facebook"></i>
                  </a>
                </li>
                <li class="list-group-item">
                  <a
                    href="https://www.youtube.com/channel/UCDkT2ZCWhK3GBtm5R-o1J4A"
                    target="_blank"
                  >
        ...
        <div class="col-md-6">
          <div class="bg-wash p-3 h-100">
            ...
            <p>
              Contract No. HHSN75N93019C00077, with additional support from the
              Wellcome Trust (Resource Grants 212929 & 218288)
            </p>
            <div class="social-buttons">
              <ul class="list-group list-group-horizontal">
                <li class="list-group-item">
                  <a href="https://twitter.com/VEuPathDB" target="_blank">
                    <i class="fab fa-twitter"></i>
                  </a>
                </li>
                <li class="list-group-item">
                  <a
                    href="https://facebook.com/pages/EuPathDB/133123003429972"
                    target="_blank"
                  >
                    <i class="fab fa-facebook"></i>
                  </a>
                ...
                <li class="list-group-item">
                  <a
                    href="https://youtube.com/user/EuPathDB/playlists"
                    target="_blank"
                  >
                    <i class="fab fa-youtube"></i>
                  </a>
